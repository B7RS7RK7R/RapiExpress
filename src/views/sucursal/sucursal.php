                    ...
                    $(document).ready(function() {
                            ...
                            $.ajax({
                                ...
                                success: function(res) {
                                    if (res.estado === 'success') {
                                        $('#sucursalModal').modal('hide'); // cierra modal
                                        $form[0].reset();
                                        Swal.fire({
                                            icon: 'success',
                                            title: 'Éxito',
                        ...
                        $(document).on('submit', 'form[id^="formEditarSucursal-"]', function(e) {
                            ...
                            $.ajax({
                                ...
                                success: function(res) {
                                    if (res.estado === 'success') {
                                        $form.closest('.modal').modal('hide'); // cierra solo este modal
                                        Swal.fire({
                                            icon: 'success',
                                            title: 'Actualizado',
                                            text: res.mensaje,
                            ...
                            $.ajax({
                                ...
                                error: function() {
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Error',
                                        text: 'No se puede eliminar la sucursal porque está asociada a clientes, paquetes, usuarios u otros registros. Primero debe desvincularla o reasignar esos registros.'
                                    });
                                }
                            });
                        });
                            ...
                            $.ajax({
                                ...
                                error: function() {
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Error',
                                        text: 'No se pudo recargar la lista de sucursales.'
                                    });
                                }
                            });
                        }
